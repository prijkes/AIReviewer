...
public class PromptLoader(ILogger<PromptLoader> logger, IOptionsMonitor<ReviewerOptions> options)
{
    ...
    public virtual async Task<string> LoadSystemPromptAsync(
    ...
    public virtual async Task<string> LoadFileReviewInstructionAsync(CancellationToken cancellationToken)
    {
    ...
    public virtual async Task<string> LoadMetadataReviewInstructionAsync(CancellationToken cancellationToken)
    {
    ...
    public virtual async Task<string> LoadLanguageInstructionAsync(string language, CancellationToken cancellationToken)
    {
