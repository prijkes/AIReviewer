...
using CoreComment = Quaaly.Core.Models.Comment;
using CorePullRequest = Quaaly.Core.Models.PullRequest;
using CoreRepository = Quaaly.Core.Models.Repository;
using CoreUserIdentity = Quaaly.Core.Models.UserIdentity;
using CoreReviewThread = Quaaly.Core.Models.ReviewThread;
using CorePullRequestStatus = Quaaly.Core.Enums.PullRequestStatus;
using AdoPullRequestStatus = Microsoft.TeamFoundation.SourceControl.WebApi.PullRequestStatus;

namespace Quaaly.Infrastructure.Providers.AzureDevOps.Adapters;
