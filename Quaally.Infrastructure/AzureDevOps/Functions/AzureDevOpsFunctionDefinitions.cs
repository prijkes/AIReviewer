...
using Quaally.Infrastructure.AI.FunctionParameters;
using Quaally.Infrastructure.AzureDevOps.Functions.Parameters;
using System.Text.Json.Serialization;

namespace Quaally.Infrastructure.AzureDevOps.Functions;
