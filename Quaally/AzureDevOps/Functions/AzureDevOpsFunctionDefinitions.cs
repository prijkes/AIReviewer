...
public static class AzureDevOpsFunctionDefinitions
{
    ...
    public static List<ChatTool> GetAllDefinitions()
    {
        ...
        [
            ...
            CreateTool<GetPrCommitsParameters>(
                "get_pr_commits",
                "Gets all commits in the pull request."
            ),
            CreateTool<GetPrWorkItemsParameters>(
                "get_pr_work_items",
